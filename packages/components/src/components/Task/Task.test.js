...
//   displayName: 'A Task',
//   id:"1233455"
// >>>>>>> badfb6ac (working on tests - data-selected attribute not getting set)
// };
...
//       />
// =======
//   //passes as it can find the content === 'astep'
//   //fails when content !== 'astep'
//   //still issue with getAttribute('data-selected') not gettting set correctly
//   it('renders first step in expanded Task with no error',async () => {
//     const steps = [
//       { name: 'a step', terminated: { reason: 'Completed', exitCode: 0 } },
//       { name: 'a step two', terminated: { reason: 'Completed', exitCode: 0  } }
//     ];
//     const { getByText } = render(<Task {...props} expanded selectDefaultStep steps={steps} />);
//      await waitFor(() =>
//      getByText((content, element) => {
//          return content === 'a step'
//         })
//       );
//   });


//   //checking test with TASK
//   //Test is working for TASK only ( it can find the content == 'A Task' and the data-selected attribute)
//   //content == 'A123Task' and the data-selected attribute - this fails the test which is correct
//   //steps are still not getting the 'data-selected' attribute
//   it('renders error step in expanded Task', async () => {
//     const steps = [
//       { name: 'a step', terminated: { reason: 'Completed',exitCode: 0  } },
...
//       getByText(
//         (content, element) =>{
//           return content === 'A Task' && element.parentNode.parentNode.getAttribute('data-selected')
//         }
//       )
// >>>>>>> badfb6ac (working on tests - data-selected attribute not getting set)
//     );
