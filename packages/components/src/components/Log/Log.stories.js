...
import Log from './Log';
import EnhancedLog from './EnhancedLog';
...
Performance2.story = {
  name: 'performance test (<20,000 lines with forked ansi-to-react)'
};

export const Performance3 = () => (
  <CustomLog
    stepStatus={{ terminated: { reason: 'Completed' } }}
    fetchLogs={() => performanceTest}
    status="Completed"
...
Performance3.story = {
  name: 'performance test (<20,000 lines with new ANSI parser)'
};
