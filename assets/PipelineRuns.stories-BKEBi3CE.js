import{j as n}from"./jsx-runtime-Bzbk6Sx8.js";import{a as oe}from"./chunk-D5ZWXAHU-5jmZk1IN.js";import"./usePrefix-DQgSqSG9.js";import{D as le}from"./Dropdown-BNZ02r3U.js";import{u as C,L as pe,V as ce}from"./index-DCmNqf1o.js";import{u as ue}from"./index-D0k5bR2p.js";import{g as p}from"./index-CfoIBI3E.js";import{C as de}from"./bucket-1-C2MJ05Nq.js";import{F as me}from"./FormattedDate-CfsM43Pp.js";import{A as fe}from"./Actions-Dl2ybR0v.js";import{T as ge}from"./Table-ZgBq0ph7.js";import{S as M}from"./StatusIcon-B3mfoTbA.js";import{R as j}from"./index-DoYbGmCh.js";import{I as Re}from"./Icon-BbW6Eq-V.js";import{F as Te}from"./FormattedDuration-DR-nx8kl.js";import{a as be,T as he}from"./bucket-17-CpsfdLmP.js";import{P as xe}from"./bucket-12-Bu6lI_iC.js";import"./v4-CQkTLCs1.js";import"./index-CiJV-Qzo.js";import"./index-B0ETwOQ0.js";import"./index-51-aJb-v.js";import"./index-CxNs_Qc2.js";import"./extends-CF3RwP-h.js";import"./index-D295wprO.js";import"./FormContext-D1Yu1AhR.js";import"./bucket-3-DW_-k99P.js";import"./mergeRefs-CTUecegF.js";import"./bucket-18-DO7kS4tX.js";import"./bucket-2-BzIGxUKv.js";import"./constants-PT-Qtcqm.js";import"./Link-BhnOnt9b.js";import"./Button-0g61YMpW.js";import"./index-SPZK-v-M.js";import"./Tooltip-BfR-5Xhs.js";import"./events-OVwOsPzJ.js";import"./MenuItem-C45H-6Q2.js";import"./useControllableState-DZFM50EU.js";import"./index-BsO2LqBO.js";import"./wrapFocus-BvAm1HsT.js";import"./noopFn-g4z370MD.js";import"./Text-9Q8NT07l.js";import"./OverflowMenuItem-iAjAaEGF.js";import"./Modal-Dv1MFLUb.js";import"./bucket-6-uvXOZeGf.js";import"./requiredIfGivenPropIsTruthy-CU7JwK8h.js";import"./index-Drl37m2w.js";import"./index-sWjxewSB.js";import"./bucket-0-DVe4YXaa.js";import"./Search-CoPmlita.js";import"./bucket-14-DDIDUikv.js";import"./Spinner-6fWOlw3V.js";import"./bucket-13-DZ_6w3Wo.js";var $;const ve=j.forwardRef(function(i,l){let{children:A,size:f=16,...x}=i;return j.createElement(Re,{width:f,height:f,ref:l,xmlns:"http://www.w3.org/2000/svg",viewBox:"0 0 32 32",fill:"currentColor",...x},$||($=j.createElement("path",{d:"M11.61,29.92a1,1,0,0,1-.6-1.07L12.83,17H8a1,1,0,0,1-1-1.23l3-13A1,1,0,0,1,11,2H21a1,1,0,0,1,.78.37,1,1,0,0,1,.2.85L20.25,11H25a1,1,0,0,1,.9.56,1,1,0,0,1-.11,1l-13,17A1,1,0,0,1,12,30,1.09,1.09,0,0,1,11.61,29.92ZM17.75,13l2-9H11.8L9.26,15h5.91L13.58,25.28,23,13Z"})),A)});function Z(e){const{status:i}=p(e);return i==="False"?n.jsxs("span",{className:"tkn--table--sub",title:p(e).message,children:[p(e).message," "]}):n.jsx("span",{className:"tkn--table--sub",children:" "})}const d=({batchActionButtons:e=[],columns:i=["run","status","pipeline","time"],customColumns:l={},filters:A,getPipelineRunCreatedTime:f=a=>a.metadata.creationTimestamp,getPipelineRunDisplayName:x=({pipelineRunMetadata:a})=>a.name,getPipelineRunDisplayNameTooltip:I=x,getPipelineRunDuration:q=a=>{const o=f(a),{lastTransitionTime:s,status:r}=p(a);let v=Date.now();return(r==="False"||r==="True")&&(v=new Date(s).getTime()),v-new Date(o).getTime()},getPipelineRunIcon:U=()=>null,getPipelineRunId:_=a=>a.metadata.uid,getPipelineRunsByPipelineURL:H=C.pipelineRuns.byPipeline,getPipelineRunStatus:w=(a,o)=>{const{reason:s}=p(a);return s||o.formatMessage({id:"dashboard.taskRun.status.pending",defaultMessage:"Pending"})},getPipelineRunStatusDetail:E=Z,getPipelineRunStatusIcon:O=a=>{const{reason:o,status:s}=p(a);return n.jsx(M,{DefaultIcon:r=>n.jsx(xe,{size:24,...r}),reason:o,status:s})},getPipelineRunStatusTooltip:K=(a,o)=>{const{message:s}=p(a),r=w(a,o);return s?`${r}: ${s}`:r},getPipelineRunTriggerInfo:z=a=>{const{labels:o={}}=a.metadata,s=o["triggers.tekton.dev/eventlistener"],r=o["triggers.tekton.dev/trigger"];return!s&&!r?null:n.jsxs("span",{title:`EventListener: ${s||"-"}
...
}`,...y.parameters?.docs?.source}}};const kn=["Default","NoPipelineLink","BatchActions","HideColumns","CustomColumns","Empty","Loading"];export{b as BatchActions,P as CustomColumns,R as Default,h as Empty,k as HideColumns,y as Loading,T as NoPipelineLink,kn as __namedExportsOrder,vn as default};
